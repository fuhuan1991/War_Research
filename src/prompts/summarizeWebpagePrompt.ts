export const summarizeWebpagePrompt = (webpageContent: string, date: string) => `
...
Respond in valid JSON with exactly these two keys:
{
  "summary": "Your summary here, structured with appropriate paragraphs or bullet points as needed",
  "key_excerpts": "First important quote or excerpt, Second important quote or excerpt, ... (up to 5)"
}
`;
